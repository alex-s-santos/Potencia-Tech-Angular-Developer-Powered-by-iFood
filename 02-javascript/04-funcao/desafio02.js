//Refatore com função para simplificar o código do exercicio da seção anterior:
...
function calcularPrecoFinal(preco, formaDePagamento) {
    ...
    let mensagem = valorAPagar ==='Opção inválida.' ? valorAPagar : `Valor a pagar: ${valorAPagar.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}.`;
    return console.log(mensagem);
};

calcularPrecoFinal(350, 1);
calcularPrecoFinal(100, 2);
calcularPrecoFinal(100, 3);
calcularPrecoFinal(100, 4);
calcularPrecoFinal(100, 5);